...
class CubeExample : public Platform::GlfwApplication
{
public:
...
CubeExample::CubeExample(const Arguments &arguments) : Platform::Application{
...
MAGNUM_APPLICATION_MAIN(CubeExample)